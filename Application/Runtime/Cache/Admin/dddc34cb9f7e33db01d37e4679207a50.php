                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form"  action="/Admin/Teacher/edit" method="post">
                                <input name="tid" type="hidden"  value="<?php echo ($list["tid"]); ?>" >
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">姓名<span class="tpl-form-line-small-title">Tname</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="tname" value="<?php echo ($list["tname"]); ?>" placeholder="请输入姓名">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                    <input type="text" name="idcard" value="<?php echo ($list["idcard"]); ?>" placeholder="请输入身份证号码">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" name="tintro" value="<?php echo ($list["tintro"]); ?>"  placeholder="请输入自我介绍"><?php echo (stripslashes(htmlspecialchars_decode($list["tintro"]))); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            ...
                                            <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                            <i class="am-icon-cloud-upload"></i> 添加资格证书图片</button>
