...
/**
	...
	public function count($arrWhere){
		$result = M('tg_live')->where($arrWhere)->count();
		return $result;
	}
	
	public function check($arrWhere){
		$result = M('tg_live')->where($arrWhere)->find();
		return $result;
	}
	...
	public function findAll($arrWhere,$first,$list){
		$result = M('tg_live')->where($arrWhere)->order('lid desc')->limit($first,$list)->select();
		return $result;
	}
	...
	public function edit($arrWhere){
		$result = M('tg_live')->data($arrWhere)->save();
		return $result;
	}
	...
	public function delete($arrWhere){
		$result = M('tg_live')->where($arrWhere)->delete();
		return $result;
	}
	/**
	 *	增加一条数据
