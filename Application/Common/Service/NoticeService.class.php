...
/**
	...
	public function count($arrWhere){
		$result = M('tg_notice')->where($arrWhere)->count();
		return $result;
	}
	
	public function check($arrWhere){
		$result = M('tg_notice')->where($arrWhere)->find();
		return $result;
	}
	...
	public function findAll($arrWhere,$first,$list){
		$result = M('tg_notice')->where($arrWhere)->order('noid desc')->limit($first,$list)->select();
		return $result;
	}
	...
	public function edit($arrWhere){
		$result = M('tg_notice')->data($arrWhere)->save();
		return $result;
	}
	...
	public function delete($arrWhere){
		$result = M('tg_notice')->where($arrWhere)->delete();
		return $result;
	}
	/**
	 *	增加一条数据
