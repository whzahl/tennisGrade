...
<!-- 		    <li class="tpl-left-nav-item">
        ...
        <div class="tpl-content-wrapper" style="margin:0 20px">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">考生信息添加页</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-font-awesome"></span> 考生信息添加
                    </div>
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="am-form-field tpl-form-no-bg" placeholder="请选择年月日" data-am-datepicker="" readonly/>
                                        <!-- <small>发布时间为必填</small> -->
                                    </div>
                                </div>
