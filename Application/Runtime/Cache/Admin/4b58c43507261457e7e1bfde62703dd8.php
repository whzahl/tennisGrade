...
<<<<<<< HEAD
                                ...
                                <div class="am-form-group">
=======
                                    <label for="user-email" class="am-u-sm-3 am-form-label">最近修改时间 <span class="tpl-form-line-small-title">Time</span></label>
                                    <div class="am-u-sm-9">
                                        <?php echo ($list["modefy_time"]); ?>
                                    </div>
                                </div>
 ...
 -->
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                    	<fieldset disabled>
                                        <div>
                                       		<!--  Amaze Ui 禁用表单 第一  <fieldset disabled></fieldset>包裹，鼠标滑过图标：am-form-field -->
											<input name="type" type="text" class="tpl-form-input am-form-field" id="user-name" value="这是一段测试的文字">
                                        </div>
                                        </fieldset>
                                    </div>
                                </div>
...
=======
 -->
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">文章内容</label>
                                    <div class="am-u-sm-9">
                                        <script id="editor" type="text/plain" style="width:900px;height:500px;" name="content">这是我填充的文本</script>  
>>>>>>> a4786106b76b85bd3f020073a24921128a17a5f5
                                    </div>
                                </div>
...
<<<<<<< HEAD
=======
                                        <a href="" class="btn btn-default" onclick ="javascript:history.go(-1);" style="margin-left:20px;">
                                        	<button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-warning ">返回</button>
                                        </a>
>>>>>>> a4786106b76b85bd3f020073a24921128a17a5f5
                                    </div>
                                </div>
