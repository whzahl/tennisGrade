...
<!-- 		                                              <a href="/Admin/Place/edit" class="am-btn am-btn-default am-btn-xs am-text-secondary" style="background-color:#fff;color:#3bb4f2;"><span class="am-icon-pencil-square-o"></span> 修改</a>
		                                              ...
		                                              <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><a href="/Admin/Place/delete?id=<?php echo ($vo["id"]); ?>" onclick="return del()"><span class="am-icon-trash-o"></span> 退款</a></button>
		                                          </div>
		                                      </div>
		                                  </td>
